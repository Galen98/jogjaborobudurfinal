...
<div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{url('insertimageselltours')}}" enctype="multipart/form-data">
                  @csrf
                  @method('post')
                  ...
                  <form class="forms-sample" method="POST" action="{{url('editimageselltours/' .$item->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('patch')
