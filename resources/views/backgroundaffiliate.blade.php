...
<div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{url('insertimageaffiliate')}}" enctype="multipart/form-data">
                  @csrf
                  @method('post')
                  ...
                  <form class="forms-sample" method="POST" action="{{url('editimageaffiliate/' .$item->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('patch')
