...
<div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{url('insertimagecontact')}}" enctype="multipart/form-data">
                  @csrf
                  @method('post')
                  ...
                  <form class="forms-sample" method="POST" action="{{url('editimagecontact/' .$item->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('patch')
