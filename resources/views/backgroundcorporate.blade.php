...
<div class="card">
                <div class="card-body">
                  ...
                  @foreach($background as $item)<form class="forms-sample" method="POST" action="{{url('editimagecorporate/' .$item->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('patch')
                  ...
                  <br/>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="tekssmall" placeholder="Masukan Subheader" value="{{$item->subheader}}">
                    </div>
