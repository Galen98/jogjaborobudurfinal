...
<html>
<head>
<title>Was your tour of {{ $reviews->namawisata }} as good as expected? </title>
        ...
        <div class="row">
            <div class="col-md-6 text-center">
              <center><img src="www.jogjaborobudur.com//traveler/images/logoabout.JPG" class="imageemail"/></center>
                <h2 style="text-align: center;">Was your tour of {{ $reviews->namawisata }} <br>as good as expected?</h2>
    <p style="text-align: center;">Hello {{ $reviews->name }}, lets review</p>
    <h3 style="text-align: center;">{{ $reviews->namawisata }}</h3>
