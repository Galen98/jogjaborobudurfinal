...
@endif
  ...
  <meta name="title" content="jogja Borobudur | {{$item->namaprovince}}" />
  <meta name="description" content="{{$item->shortdescription}}"/>
  <link rel="canonical" href="https://jogjaborobudur.com/location/{{$item->slugprovince}}/{{$item->id}}">
  <link rel="canonical" href="https://www.jogjaborobudur.com/location/{{$item->slugprovince}}/{{$item->id}}">
  <meta name="author" content="Jogja borobudur tour & travel">
  <meta name="robots" content="index, follow">
  <!-- facebook tag -->
  <meta property="og:type" content="website" />
  <meta property="og:url" content="www.jogjaborobudur.com/location/{{$item->slugprovince}}/{{$item->id}}" />
  <meta property="og:title" content="jogja Borobudur | {{$item->namaprovince}}" />
  <meta property="og:description"
    content="{{$item->shortdescription}}" />
  <meta property="og:image" content="{{ url('public/img/'.$item->image) }}" />
  <title>jogja Borobudur | {{$item->namaprovince}}</title>
  @endforeach
  <!-- end tag -->
  <style>
