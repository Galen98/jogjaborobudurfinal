...
<div class="wrapper container" style="overflow:hidden;">
      ...
      <ul class="tabs-box">
        ...
        <li> <a href="{{'/season/' .$item->id}}" class="btn btn-outline-dark no-hover {{ $seasonactive == $item->id ? 'active' : '' }}" style="border-radius:20px;">{{$item->namaseason}}</a></li>
        @endforeach
      </ul>
