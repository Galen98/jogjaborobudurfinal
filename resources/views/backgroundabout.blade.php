...
<div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{url('insertimageabout')}}" enctype="multipart/form-data">
                  @csrf
                  @method('post')
                  ...
                  <form class="forms-sample" method="POST" action="{{url('editimageabout/' .$item->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('patch')
