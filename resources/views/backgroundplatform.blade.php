...
<div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{url('insertimageplatform')}}" enctype="multipart/form-data">
                  @csrf
                  @method('post')
                  ...
                  <form class="forms-sample" method="POST" action="{{url('editimageplatform/' .$item->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('patch')
